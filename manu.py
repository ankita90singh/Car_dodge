...
pg.init()
# adding music
File="Car-Driving-B1-www.fesliyanstudios.com.mp3"
pg.init()
pg.mixer.init()
...
class Game:
    def __init__(self):
        ...
        #Creating road
        self.road1=pg.image.load("assets/road.png").convert_alpha()
        self.road1Rect=self.road1.get_rect()
        self.road2=pg.image.load("assets/road.png").convert_alpha()
        ...
        self.enemyImages=[]
        for i in range(1,5):
            img=pg.image.load(f"assets/car{i}.png").convert_alpha()
        ...
        self.scoreText = self.font.render('Score: 0', True, (0,0,0), (255,255,255))
        self.scoreTextRect = self.scoreText.get_rect()
        self.scoreTextRect.x=10
        self.scoreTextRect.y=10

        self.font2 = pg.font.Font('assets/arial.ttf', 64)
        self.gameOverText = self.font2.render('Game Over', True, (0,200,255), (0,0,200))
        self.gameOverTextRect = self.gameOverText.get_rect()
        self.gameOverTextRect.center=(self.screenWidth//2,self.screenHeight//2)

        self.font3 = pg.font.Font('assets/arial.ttf', 25)
        self.welcomeText = self.font3.render('WELCOME TO CAR DODGE', True, (0,0,200),(200,255,255))
        self.welcomeTextRect = self.gameOverText.get_rect()
        self.welcomeTextRect.center=(self.screenWidth//2,self.screenHeight//2)
    ...
    def updateScore(self):
        self.score+=1
        self.scoreText = self.font.render(f'Score: {self.score}', True, (200,200,255), (0,0,200))
    ...
    def gameLoop(self):
        ...
        while True:
            ...
            #self.win.blit(self.welcomeText,self.welcomeTextRect)
    ...
    # checks collision of enemies and player
    ...
    # generates enemies according to the count and last x position
